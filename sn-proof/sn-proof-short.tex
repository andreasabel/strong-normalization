...
If $\Gamma \vdash R : A \arrow B$ is neutral and $\Gamma \vdash R~N \red Q : B$, then $Q$ is neutral\ednote{It might be nice to have a judgment form for ``$M$ is neutral''? -ah}.
\end{lemma}
\begin{proof}
