...
\end{lemma}
\begin{proof}
Proof by case analysis and induction. Recall that $C[M_1] = \underline{M_1}~N_1 \ldots N_n$ where $C = \_~N_1 \ldots N_n$.
Moreover, we have 
...
{\color{red}{TO SHOW: $\Gamma \vdash C[(\lambda x.M')~N] : B' \in \csn$}}
